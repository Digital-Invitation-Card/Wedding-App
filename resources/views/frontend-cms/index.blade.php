...
<head>
    <meta charset="utf-8">
    <title>Mr&Mrs {{$data['groom_first_name']}} {{$data['bride_first_name']}}</title>
    ...
    <link href="{{asset('frontend_asset/lib/animate/animate.min.css')}}" rel="stylesheet">
    <link href="{{asset('frontend_asset/lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet">
...
<body data-bs-spy="scroll" data-bs-target="#navBar" id="weddingHome">
        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="{{asset('frontend_asset/img/carousel-1.jpg')}}" class="img-fluid" alt="Image">
                    <div class="carousel-caption">
                        <div class="p-3 mx-auto animated zoomIn" style="max-width: 900px;">
                            ...
                            <h1 class="display-1 text-capitalize text-white mb-3">{{$data['groom_first_name']}}<i class="fa fa-heart text-primary"></i> {{$data['bride_first_name']}}</h1>
                ...
                <div class="carousel-item">
                    <img src="{{asset('frontend_asset/img/carousel-2.jpg')}}" class="img-fluid" alt="Image">
                    <div class="carousel-caption">
                        <div class="p-3 mx-auto animated zoomIn" style="max-width: 900px;">
                            <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-5" style="border-style: double;">
                                <h4 class="text-white text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">WE ARE GETTING MARRIED</h4>
                            ...
                            <h1 class="display-1 text-capitalize text-white mb-3">{{$data['groom_first_name']}} <i class="fa fa-heart text-primary"></i> {{$data['bride_first_name']}}</h1>
                            <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-4" style="border-style: double;">
                                <h4 class="text-white text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">{{$data['wedding_date']}} </h4>
                            </div>
                            <div class="d-flex align-items-center justify-content-center">
                                <a class="btn btn-primary btn-primary-outline-0 py-3 px-5" href="#">RSVP Now</a>
                            </div>
                ...
                <div class="carousel-item">
                    <img src="{{asset('frontend_asset/img/carousel-3.png')}}" class="img-fluid bg-secondary" alt="Image">
                    <div class="carousel-caption">
                        <div class="p-3 mx-auto animated zoomIn" style="max-width: 900px;">
                            <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-4" style="border-style: double;">
                                <h4 class="text-white text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">WE ARE GETTING MARRIED</h4>
                            </div>
                            <h1 class="display-1 text-capitalize text-white mb-3">{{$data['bride_first_name']}} <i class="fa fa-heart text-primary"></i> {{$data['groom_first_name']}}</h1>
                            <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-4" style="border-style: double;">
                                <h4 class="text-white text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">{{$data['wedding_date']}}</h4>
                            </div>
                            <div class="d-flex align-items-center justify-content-center">
    ...
    <div class="container-fluid position-relative py-5" id="weddingAbout">
        <div class="position-absolute" style="top: -35px; right: 0;">
            <img src="{{asset('frontend_asset/img/tamp-bg-1.png')}}" class="img-fluid" alt="">
        </div>
                        ...
                        <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="d-flex">
                                <div class="text-end my-auto pe-4">
                                    <h3 class="text-primary mb-3">Priya</h3>
                        ...
                        <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="d-flex">
                                ...
                                <div class="my-auto ps-4">
                                    <h3 class="text-primary mb-3">Ganesh</h3>
                                    <p class="text-dark mb-0" style="line-height: 30px;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                    </p>
                                </div>
                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="d-flex">
                                                ...
                                                <div class="text-start my-auto">
                                                    <h5 class="text-white fw-bold">Priya</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex">
                                                ...
                                                <div class="text-start my-auto">
                                                    <h5 class="text-white fw-bold">Ganesh</h5>
                                                    <p class="text-white mb-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                                    </p>
                                                    <!-- <div class="d-flex">
                                                        <a href="" class="btn btn-primary btn-primary-outline-0 btn-sm-square me-2"><i class="fab fa-facebook-f"></i></a>
            ...
            <div class="story-timeline">
                <div class="row wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="col-md-6 border-start border-top border-secondary p-4 pe-0">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4">
                            <h4 class="mb-2 text-dark">Haldi Function</h4>
                            <p class="text-uppercase text-primary mb-2" style="letter-spacing: 3px;">{{$data['haldi_date']}}</p>
                            <p class="m-0 fs-5">{{$data['reception_function_address']}}.</p>
                        </div>
                    </div>
                </div>
                <div class="row flex-column-reverse flex-md-row wow fadeInUp" data-wow-delay="0.3s">
                    <div class="col-md-6 text-end border-end border-top border-secondary p-4 ps-0">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4">
                            <h4 class="text-dark mb-2">Reception Date</h4>
                            <p class="text-uppercase text-primary mb-2" style="letter-spacing: 3px;">{{$data['reception_date']}}</p>
                            <p class="m-0 fs-5">{{$data['reception_function_address']}}</p>
                        </div>
                    </div>
                ...
                <div class="row wow fadeInUp" data-wow-delay="0.4s">
                    ...
                    <div class="col-md-6 border-start border-top border-secondary p-4 pe-0">
                        <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4">
                            <h4 class="text-dark mb-2">Wedding Date</h4>
                            <p class="text-uppercase text-primary mb-2" style="letter-spacing: 3px;">{{$data['wedding_date']}} </p>
                            <p class="m-0 fs-5">{{$data['wedding_address']}}</p>
                        </div>
                    </div>
                </div>
    ...
    <!-- Story End -->
    <?php
    if (strtotime(date("Y-m-d")) > strtotime($data['wedding_date'])) {
        $expired = true;
    } else {
        $expired = false;
        $seconds = strtotime($data['wedding_date']) - time();
        ...
        <div class="container py-5 wow zoomIn" data-wow-delay="0.1s">
            <div class="wedding-date text-center bg-light p-5" style="border-style: double !important; border: 15px solid rgba(253, 93, 93, 0.5);">
                <div class="wedding-date-content">
                    <div class="d-inline-block border-end-0 border-start-0 border-secondary p-2 mb-4" style="border-style: double;">
                        <h4 class="text-dark text-uppercase fw-bold mb-0" style="letter-spacing: 3px;">{{$data['wedding_date']}}</h4>
                    </div>
                    <h1 class="display-4">We Are Getting Married</h1>
                    <p class="text-dark fs-5">{{$data['wedding_address']}}</p>
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{asset('frontend_asset/img/Groomsmen-1.png')}}" class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                <img src="{{asset('frontend_asset/img/team-1-bg.png')}}" class="img-fluid" alt="">
                            </div>
                            <div class="team-img-bg position-absolute" style="bottom: -40px; right: -120px; transform: rotate(-30deg); z-index: 1;">
                                <img src="{{asset('frontend_asset/img/team-1-bg.png')}}" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{asset('frontend_asset/img/Groomsmen-2.png')}}" class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                <img src="{{asset('frontend_asset/img/team-1-bg.png')}}" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{asset('frontend_asset/img/Groomsmen-3.png')}}" class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                <img src="{{asset('frontend_asset/img/team-1-bg.png')}}" class="img-fluid" alt="">
                            </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                    <div class="team-item">
                        <div class="team-img">
                            <div class="team-img-main">
                                <img src="{{asset('frontend_asset/img/Groomsmen-4.png')}}" class="img-fluid w-100" alt="">
                            </div>
                            <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                <img src="{{asset('frontend_asset/img/team-1-bg.png')}}" class="img-fluid" alt="">
                            </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-center">
                ...
                <div class="col-md-6 text-center text-md-end text-white">
                    ...
                    <script src="{{asset('frontend_asset/lib/wow/wow.min.js')}}"></script>
                    <script src="{{asset('frontend_asset/lib/easing/easing.min.js')}}"></script>
                    <script src="{{asset('frontend_asset/lib/waypoints/waypoints.min.js')}}"></script>
                    <script src="{{asset('frontend_asset/lib/lightbox/js/lightbox.min.js')}}"></script>
